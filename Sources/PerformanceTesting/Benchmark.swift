...
public struct Benchmark <Subject> {
    ...
    /// Creates a `Benchmark` for an `operation` which mutates a `Subject` generated by `setup`.
    ...
    /// Creates a `Benchmark` for an `operation` which acts on a `Subject` generated by `setup`.
    /// This operation will be measured `trialCount` times at each of the sizes in `testPoints`.
